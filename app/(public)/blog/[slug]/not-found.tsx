...
export default function PostNotFound() {
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center relative overflow-hidden py-12 px-4">
      {/* Animated gradient orbs */}
      <div className="absolute inset-0 overflow-hidden">
        <div 
          className="absolute rounded-full opacity-15 blur-3xl transition-all duration-1000 ease-out"
          style={{
            width: '400px',
            height: '400px',
            background: isDark 
        ...
        <div 
          className="absolute rounded-full opacity-10 blur-3xl animate-float-reverse"
          style={{
            width: '300px',
            height: '300px',
            background: isDark
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col items-center justify-center space-y-6 text-center max-w-2xl">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 dark:from-white dark:via-slate-100 dark:to-white bg-clip-text text-transparent">
          Not Found
        </h2>
